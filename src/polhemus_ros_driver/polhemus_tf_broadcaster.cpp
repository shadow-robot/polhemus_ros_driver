...
int main(int argc, char** argv)
{
  ...
  tf_queue.reserve(16);
  ros::Rate rate(240);  // Previously hardcoded to 120 Hz
  int flag = 0;
  ...
  while (ros::ok())
  {
    ...
    else
    {
      ...
      */
      ...
      {
        // The box starts counting before we are reading it so there are always some frames missed at the beginning
      }
